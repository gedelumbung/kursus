		...
		<div id="navigation" style="width:290px;">
			...
			<ul class="mainNav" data-open-subnavs="multi" style="width:280px;">
				...
				<li class='active'>
					...
					<ul class="subnav">
						<li>
							<a href="<?php echo Yii::app()->baseUrl; ?>/pengajar"><i class="icon-th-list icon-white"></i><span> Data Pengajar</span></a>
						</li>
						<li>
							<a href="<?php echo Yii::app()->baseUrl; ?>/program"><i class="icon-hdd icon-white"></i><span> Data Program</span></a>
						</li>
					</ul>
				</li>

				<li class='active'>
					<a href="#"><i class="icon-th-large icon-white"></i><span>Transaksi</span><span class="label">2</span></a>
					<ul class="subnav">
						<li>
							<a href="<?php echo Yii::app()->baseUrl; ?>/gaji_insentif"><i class="icon-th-list icon-white"></i><span> Gaji Insentif</span></a>
						</li>
						<li>
							<a href="<?php echo Yii::app()->baseUrl; ?>/tunjangan"><i class="icon-hdd icon-white"></i><span> Tunjangan dan Lainnya</span></a>
						</li>
					</ul>
				</li>
