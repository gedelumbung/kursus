...
/**
 * This is the model class for table "tbl_pengajar".
 *
 * The followings are the available columns in table 'tbl_pengajar':
...
class Pengajar extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id_pengajar, nama, alamat, created_at, updated_at', 'safe', 'on'=>'search'),
		);
	}
